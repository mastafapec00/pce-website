...
// 🟢 Yahan main ne har logo ke sath uske Sub-page ka link daal diya hai
const partnerLogos = [
    ...
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900">
      ...
      <section className="py-20 bg-slate-50 border-t border-slate-200 flex flex-col justify-center items-center">
        <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-12 flex flex-col justify-center items-center">
          ...
          <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="bg-gradient-to-br from-green-800 to-green-950 rounded-3xl p-10 text-white shadow-xl relative overflow-hidden flex flex-col justify-center items-center w-full">
            ...
            <div className="space-y-6 relative z-10 flex flex-col justify-center items-center w-full">
              <div className="bg-white/10 p-6 rounded-2xl border border-white/20 backdrop-blur-sm flex flex-col justify-center items-center w-full">
                <label className="text-sm font-bold uppercase tracking-widest text-green-200 block mb-3 text-center">You Give (Amount)</label>
              ...
              <div className="bg-white/10 p-6 rounded-2xl border border-white/20 backdrop-blur-sm flex flex-col justify-center items-center w-full">
                <div className="flex items-center justify-center gap-3 mb-3">
                  ...
                  <label className="text-sm font-bold uppercase tracking-widest text-green-200 block text-center">Select Currency</label>
                </div>
          ...
          <div className="flex flex-wrap justify-center gap-6 w-full">
            {newServicesData.map((service, index) => (
              <motion.a 
                ...
                viewport={{ once: true }} 
                className="bg-white border border-slate-200 p-8 rounded-2xl hover:shadow-xl hover:border-green-200 transition duration-300 flex flex-col items-center justify-center text-center w-full md:w-[calc(50%-1.5rem)] lg:w-[calc(33.333%-1.5rem)] group"
              >
                <div className="w-16 h-16 bg-green-50 rounded-2xl flex items-center justify-center mb-6 shadow-sm group-hover:scale-110 group-hover:shadow-md group-hover:bg-green-700 group-hover:text-white transition-all duration-300 text-green-700">
                  {service.icon}
                </div>
      ...
      <section className="py-24 bg-slate-50 border-t border-slate-200 flex flex-col justify-center items-center">
        <div className="container mx-auto px-6 flex flex-col justify-center items-center">
          <div className="text-center mb-16 flex flex-col justify-center items-center">
            <h2 className="text-4xl md:text-5xl font-black text-slate-900 mb-4 flex items-center gap-3">
               <ShieldCheck size={40} className="text-red-600" /> Why Choose Us?
            </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 flex flex-col justify-center items-center w-full">
            {reasonsData.map((item, index) => (
              <motion.div key={index} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ delay: index * 0.1 }} viewport={{ once: true }} className="bg-white p-8 rounded-3xl shadow-sm hover:shadow-lg hover:-translate-y-2 transition-all duration-300 border border-slate-100 group flex flex-col justify-center items-center text-center">
                <div className="mb-6 bg-green-50 w-16 h-16 rounded-2xl flex items-center justify-center group-hover:bg-green-700 group-hover:text-white group-hover:shadow-md transition-all duration-300 text-green-700">
                  {item.icon}
                </div>
      ...
      <section className="py-12 bg-white border-t border-slate-100 flex flex-col justify-center items-center">
        <div className="container mx-auto px-6 mb-8 text-center flex flex-col justify-center items-center">
          <p className="text-slate-400 font-bold uppercase tracking-widest text-sm flex items-center justify-center gap-2">🤝 OUR VALUED PARTNERS</p>
        </div>
        <div className="flex whitespace-nowrap overflow-hidden justify-center items-center w-full">
          <motion.div animate={{ x: ["0%", "-50%"] }} transition={{ ease: "linear", duration: 20, repeat: Infinity }} className="flex items-center justify-center gap-16 pr-16">
            {[...partnerLogos, ...partnerLogos].map((partner, index) => (
              {/* 🟢 Yahan main ne div ko 'a' tag (link) mein badal diya hai */}
              <a href={partner.linkUrl} key={index} className="px-8 py-4 flex flex-col items-center justify-center w-48 h-24 bg-white rounded-xl shadow-sm border border-slate-100 overflow-hidden group cursor-pointer hover:shadow-md transition-all duration-300 hover:border-green-200">
                <img 
                  src={partner.url} 
                  alt={partner.name} 
                  className="w-full h-full object-contain opacity-80 hover:opacity-100 transition grayscale hover:grayscale-0 group-hover:scale-105" 
      ...
      <footer className="bg-slate-950 text-slate-300 py-16 text-sm border-t-4 border-green-700 flex flex-col justify-center items-center">
        <div className="container mx-auto px-6 grid md:grid-cols-4 gap-12 mb-12 flex flex-col justify-center items-center w-full text-center">
          ...
          <div className="flex flex-col justify-center items-center">
            ...
            <ul className="space-y-4 font-medium flex flex-col justify-center items-center w-full">
              <li className="flex items-center justify-center gap-3 w-full"><MapPin size={20} className="text-green-500 shrink-0" /><span>Head Office, Karachi, Pakistan</span></li>
              <li className="flex items-center justify-center gap-3 w-full"><Phone size={20} className="text-green-500 shrink-0" /><span>UAN: 111-XXX-XXX</span></li>
              <li className="flex items-center justify-center gap-3 w-full"><Mail size={20} className="text-green-500 shrink-0" /><span>info@pce.com.pk</span></li>
            </ul>
          </div>
        </div>
